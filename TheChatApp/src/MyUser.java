...
public class MyUser extends User implements Runnable, Serializable {
    ...
    public byte[] encryptPrivate(PrivateKey privateKey, String message) throws Exception{
        Cipher cipher = Cipher.getInstance("RSA");  
    ...
    public String decryptPrivate(PublicKey publicKey, byte[] encrypted) throws Exception{
        Cipher cipher = Cipher.getInstance("RSA");  
